 ...
 */
public class WmsInveCustomerMonthlyIncomeBeanVo extends GridParamBean {
    ...
    private Integer is_query_pay_status;// 支付状态：1为已支付,2为未支付
    ...
    public Integer getIs_query_pay_status()
    {
        return is_query_pay_status;
    }

    public void setIs_query_pay_status(Integer is_query_pay_status)
    {
        this.is_query_pay_status = is_query_pay_status;
    }
