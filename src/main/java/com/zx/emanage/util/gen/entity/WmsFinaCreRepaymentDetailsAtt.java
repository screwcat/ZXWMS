...
public class WmsFinaCreRepaymentDetailsAtt implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_fina_cre_repayment_details_att_id;
	...
	*/	
	...
	public Integer getWms_fina_cre_repayment_details_att_id () {
		return wms_fina_cre_repayment_details_att_id;
	}
	
	public void setWms_fina_cre_repayment_details_att_id (Integer obj) {
		wms_fina_cre_repayment_details_att_id = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_fina_cre_repayment_details_att_id", this.wms_fina_cre_repayment_details_att_id);
