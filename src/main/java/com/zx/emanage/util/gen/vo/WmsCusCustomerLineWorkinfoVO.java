...
public class WmsCusCustomerLineWorkinfoVO implements Serializable
{
    ...
    private String work_unit_entry_date;
    ...
    public String getWork_unit_entry_date()
    {
        return work_unit_entry_date;
    }

    public void setWork_unit_entry_date(String obj)
    {
