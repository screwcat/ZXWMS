...
public class WmsInveCommissionGeneralNetRulesNew implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_inve_commission_general_net_rules_new_id;
	...
	*/	
	private static String[] pkColArr = {
	  	"wms_inve_commission_general_net_rules_new_id"
	};
	...
	public Integer getWms_inve_commission_general_net_rules_new_id () {
		return wms_inve_commission_general_net_rules_new_id;
	}
	
	public void setWms_inve_commission_general_net_rules_new_id (Integer obj) {
		wms_inve_commission_general_net_rules_new_id = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_inve_commission_general_net_rules_new_id", this.wms_inve_commission_general_net_rules_new_id);
