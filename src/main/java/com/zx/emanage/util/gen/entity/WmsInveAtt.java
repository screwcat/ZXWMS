...
public class WmsInveAtt implements BaseEntity
{
    private static final long serialVersionUID = 1L;

    private Integer wms_inve_att_id;
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_inve_att_id" };

    private static String[] columnNameArr = { "wms_inve_att_id", "wms_inve_transa_id", "data_type",
                                             "attachment_old_name", "attachment_new_name", "attachment_address",
                                             "attachment_type", "isExcludePKFlag" };

    public Integer getWms_inve_att_id()
    {
        return wms_inve_att_id;
    }

    public void setWms_inve_att_id(Integer obj)
    {
        wms_inve_att_id = obj;
    }
    ...
    {
        paramMap.put("wms_inve_att_id", this.wms_inve_att_id);
