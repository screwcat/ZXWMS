...
public class WmsCusCustomerLineHouseinfo implements BaseEntity
{
    ...
    private static String[] columnNameArr = { "wms_cus_customer_line_houseinfo_id", "house_buy_date",
                                             ...
                                             "house_address_more", "house_post_code", "wms_cus_customer_id",
                                             "create_user_id", "create_timestamp", "create_timestamp_str",
                                             "last_update_user_id", "last_update_timestamp",
                                             "last_update_timestamp_str", "enable_flag", "house_address_street",
                                             "is_supp_house_card", "house_type", "house_no", "house_vol_no",
                                             "community_name" };
