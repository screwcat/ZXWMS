...
public class WmsCusCustomerHead implements BaseEntity
{
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cus_customer_id" };

    private static String[] columnNameArr = { "wms_cus_customer_id", "customer_code", "customer_name",
                                             ...
                                             "last_update_timestamp_str", "enable_flag", "work_stat", "house_stat",
                                             "residence_time", "cre_card_num", "existing_loan", "monthly_income",
                                             "resource_of_tel1", "resource_of_tel2", "is_real_name_tel1",
                                             "is_real_name_tel2", "real_name_tel1", "real_name_rela1",
                                             "real_name_tel2", "real_name_rela2" };
