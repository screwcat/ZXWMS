...
public class WmsCreCarpHousingAtt implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_cre_carp_housing_att_id;
	...
	*/	
	...
	public Integer getWms_cre_carp_housing_att_id () {
		return wms_cre_carp_housing_att_id;
	}
	
	public void setWms_cre_carp_housing_att_id (Integer obj) {
		wms_cre_carp_housing_att_id = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_cre_carp_housing_att_id", this.wms_cre_carp_housing_att_id);
