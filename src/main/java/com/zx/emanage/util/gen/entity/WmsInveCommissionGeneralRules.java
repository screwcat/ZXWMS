...
public class WmsInveCommissionGeneralRules implements BaseEntity {
	...
	private java.math.BigDecimal base_commission_disposable;
	
	private java.math.BigDecimal positive_commission_disposable;
	
	private java.math.BigDecimal base_commission_monthly1;
	
	private java.math.BigDecimal positive_commission_monthly1;
	
	private java.math.BigDecimal base_commission_monthly2;
	
	private java.math.BigDecimal positive_commission_monthly2;
	...
	*/	
	...
	public java.math.BigDecimal getBase_commission_disposable () {
		return base_commission_disposable;
	}
	
	public void setBase_commission_disposable (java.math.BigDecimal obj) {
		base_commission_disposable = obj;
	}
	
	public java.math.BigDecimal getPositive_commission_disposable () {
		return positive_commission_disposable;
	}
	
	public void setPositive_commission_disposable (java.math.BigDecimal obj) {
		positive_commission_disposable = obj;
	}
	
	public java.math.BigDecimal getBase_commission_monthly1 () {
		return base_commission_monthly1;
	}
	
	public void setBase_commission_monthly1 (java.math.BigDecimal obj) {
		base_commission_monthly1 = obj;
	}
	
	public java.math.BigDecimal getPositive_commission_monthly1 () {
		return positive_commission_monthly1;
	}
	
	public void setPositive_commission_monthly1 (java.math.BigDecimal obj) {
		positive_commission_monthly1 = obj;
	}
	
	public java.math.BigDecimal getBase_commission_monthly2 () {
		return base_commission_monthly2;
	}
	
	public void setBase_commission_monthly2 (java.math.BigDecimal obj) {
		base_commission_monthly2 = obj;
	}
	
	public java.math.BigDecimal getPositive_commission_monthly2 () {
		return positive_commission_monthly2;
	}
	
	public void setPositive_commission_monthly2 (java.math.BigDecimal obj) {
		positive_commission_monthly2 = obj;
	}
	...
	public void setPage_rule_state (String obj) {
		page_rule_state = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		...
		paramMap.put("base_commission_disposable", this.base_commission_disposable);
		paramMap.put("positive_commission_disposable", this.positive_commission_disposable);
		paramMap.put("base_commission_monthly1", this.base_commission_monthly1);
		paramMap.put("positive_commission_monthly1", this.positive_commission_monthly1);
		paramMap.put("base_commission_monthly2", this.base_commission_monthly2);
		paramMap.put("positive_commission_monthly2", this.positive_commission_monthly2);
