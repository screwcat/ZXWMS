...
public class WmsInveCommissionCategory implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_inve_commission_category_id;
	...
	*/	
	...
	public Integer getWms_inve_commission_category_id () {
		return wms_inve_commission_category_id;
	}
	
	public void setWms_inve_commission_category_id (Integer obj) {
		wms_inve_commission_category_id = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_inve_commission_category_id", this.wms_inve_commission_category_id);
