...
public class WmsCreHousingAtt implements BaseEntity
{
    private static final long serialVersionUID = 1L;

    private Integer wms_cre_housing_att_id;
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cre_housing_att_id" };

    private static String[] columnNameArr = { "wms_cre_housing_att_id", "data_type", "attachment_old_name",
                                             "attachment_new_name", "attachment_address", "attachment_type",
    ...
    public Integer getWms_cre_housing_att_id()
    {
        return wms_cre_housing_att_id;
    }

    public void setWms_cre_housing_att_id(Integer obj)
    {
        wms_cre_housing_att_id = obj;
    }
    ...
    {
        paramMap.put("wms_cre_housing_att_id", this.wms_cre_housing_att_id);
