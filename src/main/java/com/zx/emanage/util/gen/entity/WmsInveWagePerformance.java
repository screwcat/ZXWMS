...
public class WmsInveWagePerformance implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_inve_wage_performance_id;
	...
	private java.math.BigDecimal floating_wage;
	...
	*/	
	...
	public Integer getWms_inve_wage_performance_id () {
		return wms_inve_wage_performance_id;
	}
	
	public void setWms_inve_wage_performance_id (Integer obj) {
		wms_inve_wage_performance_id = obj;
	}
	...
	public java.math.BigDecimal getFloating_wage () {
		return floating_wage;
	}
	
	public void setFloating_wage (java.math.BigDecimal obj) {
		floating_wage = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_inve_wage_performance_id", this.wms_inve_wage_performance_id);
		...
		paramMap.put("floating_wage", this.floating_wage);
