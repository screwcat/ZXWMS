...
public class WmsInveCommissionFloating implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_inve_commission_floating_id;
	...
	*/	
	...
	public Integer getWms_inve_commission_floating_id () {
		return wms_inve_commission_floating_id;
	}
	
	public void setWms_inve_commission_floating_id (Integer obj) {
		wms_inve_commission_floating_id = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_inve_commission_floating_id", this.wms_inve_commission_floating_id);
