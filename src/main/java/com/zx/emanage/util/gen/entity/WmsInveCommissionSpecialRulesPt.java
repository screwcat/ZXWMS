...
public class WmsInveCommissionSpecialRulesPt implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_inve_commission_special_rules_pt_id;
	...
	*/	
	...
	public Integer getWms_inve_commission_special_rules_pt_id () {
		return wms_inve_commission_special_rules_pt_id;
	}
	
	public void setWms_inve_commission_special_rules_pt_id (Integer obj) {
		wms_inve_commission_special_rules_pt_id = obj;
	}
	...
	public void setWms_inve_commission_personnel_reward_id(
			Integer wms_inve_commission_personnel_reward_id) {
		this.wms_inve_commission_personnel_reward_id = wms_inve_commission_personnel_reward_id;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_inve_commission_special_rules_pt_id", this.wms_inve_commission_special_rules_pt_id);
