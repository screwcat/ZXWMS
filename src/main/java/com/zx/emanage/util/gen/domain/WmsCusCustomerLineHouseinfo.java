...
public class WmsCusCustomerLineHouseinfo implements Serializable
{
    private static final long serialVersionUID = 1L;

    private Integer wms_cus_customer_line_houseinfo_id;
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cus_customer_line_houseinfo_id" };

    private static String[] columnNameArr = { "wms_cus_customer_line_houseinfo_id", "house_buy_date",
                                             "house_buy_money", "house_building_area", "house_address_province",
                                             "house_address_city", "house_address_district", "house_address_more",
                                             "house_post_code", "wms_cus_customer_id", "create_user_id",
                                             "create_timestamp", "last_update_user_id", "last_update_timestamp",
                                             "enable_flag" };

    public Integer getWms_cus_customer_line_houseinfo_id()
    {
        return wms_cus_customer_line_houseinfo_id;
    }

    public void setWms_cus_customer_line_houseinfo_id(Integer obj)
    {
        wms_cus_customer_line_houseinfo_id = obj;
    }
    ...
    {
        paramMap.put("wms_cus_customer_line_houseinfo_id", this.wms_cus_customer_line_houseinfo_id);
    ...
    {
        if (paramMap.get("wms_cus_customer_line_houseinfo_id") == null)
        {
            paramMap.remove("wms_cus_customer_line_houseinfo_id");
        }
        ...
        if (paramMap.get("wms_cus_customer_id") == null)
        {
            paramMap.remove("wms_cus_customer_id");
        }
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_INSERT,
     ...
     */
    public static int deleteRecordsByPK(AbstractSimpleDao dao, Integer wms_cus_customer_line_houseinfo_id)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("wms_cus_customer_line_houseinfo_id", wms_cus_customer_line_houseinfo_id);
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_DELETE, paramMap);
    }
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_UPDATE_ALL,
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_UPDATE,
     ...
     */
    public static WmsCusCustomerLineHouseinfo getRecordDomainByPK(AbstractSimpleDao dao,
                                                                  Integer wms_cus_customer_line_houseinfo_id)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("wms_cus_customer_line_houseinfo_id", wms_cus_customer_line_houseinfo_id);
        WmsCusCustomerLineHouseinfo bean = dao.qryObj(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_LIST, paramMap,
                                                      WmsCusCustomerLineHouseinfo.class);
        return bean;
    }
     ...
     */
    public static WmsCusCustomerLineHouseinfoVO getRecordVOByPK(AbstractSimpleDao dao,
                                                                Integer wms_cus_customer_line_houseinfo_id)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("wms_cus_customer_line_houseinfo_id", wms_cus_customer_line_houseinfo_id);
        List<Map<String, Object>> resList = dao.queryForListByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_LIST,
                                                                       paramMap);
        WmsCusCustomerLineHouseinfoVO bean = new WmsCusCustomerLineHouseinfoVO();
        if (resList.size() > 0)
        {
            Map<String, Object> row = resList.get(0);
            if (row.get("wms_cus_customer_line_houseinfo_id") != null)
            {
                bean.setWms_cus_customer_line_houseinfo_id((Integer) row.get("wms_cus_customer_line_houseinfo_id"));
            }
            ...
            if (row.get("wms_cus_customer_id") != null)
            {
                bean.setWms_cus_customer_id((Integer) row.get("wms_cus_customer_id"));
            }
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_DELETE,
                                    dealWithMapNullVal(this.getInfoMap()));
    }

    /**
     * get list by "and" method, need new WmsCusCustomerLineHouseinfo() include
     * query-params
     */
    public static List<WmsCusCustomerLineHouseinfo> getSingleTableListByAndMethod(AbstractSimpleDao dao,
                                                                                  WmsCusCustomerLineHouseinfo queryInfo,
                                                                                  Boolean isExcludePKFlag)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        if (queryInfo.getWms_cus_customer_line_houseinfo_id() != null)
        {
            paramMap.put("wms_cus_customer_line_houseinfo_id", queryInfo.getWms_cus_customer_line_houseinfo_id());
        }
        ...
        return dao.qryObjList(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_LIST,
                              setSymbolPKPrior(paramMap, isExcludePKFlag, false), WmsCusCustomerLineHouseinfo.class);
    }

    /**
     * get list by "or" method, need new WmsCusCustomerLineHouseinfo() include
     * query-params
     */
    public static List<WmsCusCustomerLineHouseinfo> getSingleTableListByOrMethod(AbstractSimpleDao dao,
                                                                                 WmsCusCustomerLineHouseinfo queryInfo,
                                                                                 Boolean isExcludePKFlag)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return dao.qryObjList(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_HOUSEINFO_LIST_BY_OR,
                              setSymbolPKPrior(paramMap, isExcludePKFlag, true), WmsCusCustomerLineHouseinfo.class);
    }
