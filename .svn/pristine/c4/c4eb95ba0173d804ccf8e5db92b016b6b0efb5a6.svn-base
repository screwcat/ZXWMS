 ...
 * 系统名称：财富管理平台
 * @ClassName: WmsCreRevCertificateMainDao
 * 模块名称：
 * @Description: 内容摘要：
 * @author baisong
 * @date 2016年12月27日
 ...
 */
@MyBatisRepository
public interface WmsCreRevCertificateMainDao extends BaseDao<WmsCreRevCertificateMain>
{
    void deleteForId(Map<String, Object> params);
    ...
    */
    List<WmsCreRevCertificateMain> getCopyInfo(Integer id);
    ...
    */
    void saveBatch(List<WmsCreRevCertificateMain> list);
}