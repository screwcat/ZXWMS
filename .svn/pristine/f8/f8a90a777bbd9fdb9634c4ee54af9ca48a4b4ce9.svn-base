...
public class WmsCusCustomerChild implements BaseEntity
{
    private static final long serialVersionUID = 1L;

    private Integer wms_cus_customer_child_id;
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cus_customer_child_id" };

    private static String[] columnNameArr = { "wms_cus_customer_child_id", "wms_cus_customer_id", "child_name",
    ...
    public Integer getWms_cus_customer_child_id()
    {
        return wms_cus_customer_child_id;
    }

    public void setWms_cus_customer_child_id(Integer obj)
    {
        wms_cus_customer_child_id = obj;
    }
    ...
    {
        paramMap.put("wms_cus_customer_child_id", this.wms_cus_customer_child_id);
