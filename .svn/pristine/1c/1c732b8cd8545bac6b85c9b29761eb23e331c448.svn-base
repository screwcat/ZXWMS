...
public class WmsInveWagerulesHead implements BaseEntity {
	...
	private java.math.BigDecimal positive_wage;
	...
	*/	
	...
	public void setPost_id (Integer obj) {
		post_id = obj;
	}
	...
	public java.math.BigDecimal getPositive_wage () {
		return positive_wage;
	}
	
	public void setPositive_wage (java.math.BigDecimal obj) {
		positive_wage = obj;
	}
	...
	public void setStop_date(java.sql.Date stop_date) {
	...
	public void setStop_date_str(String stop_date_str) {
		this.stop_date_str = stop_date_str;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		...
		paramMap.put("post_id", this.post_id);
		paramMap.put("base_wage", this.base_wage);
		paramMap.put("positive_wage", this.positive_wage);
