package com.zx.emanage.telUserLoanInfo.vo;

import java.sql.Timestamp;

import com.zx.platform.syscontext.vo.GridParamBean;

public class WmsCreCreditNotificationMessageSearchBeanVO extends GridParamBean {

    private static final long serialVersionUID = 1L;

    /** 主键 **/
    private Integer wms_cre_credit_notification_message_id;
    ...
    public void setWms_cre_credit_notification_message_id(Integer wms_cre_credit_notification_message_id) {
        this.wms_cre_credit_notification_message_id = wms_cre_credit_notification_message_id;
    }

    public Integer getWms_cre_credit_notification_message_id() {
