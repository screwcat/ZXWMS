...
public class WmsCreCarpHouseAssessment implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_cre_carp_house_assessment_id;
	...
	*/	
	private static String[] pkColArr = {
	  	"wms_cre_carp_house_assessment_id"
	};
	...
	public Integer getWms_cre_carp_house_assessment_id () {
		return wms_cre_carp_house_assessment_id;
	}
	
	public void setWms_cre_carp_house_assessment_id (Integer obj) {
		wms_cre_carp_house_assessment_id = obj;
	}
	...
	public void setCommunity_name1(String community_name1) {
		this.community_name1 = community_name1;
	}
	...
	public void setHouse_building_area1(java.math.BigDecimal house_building_area1) {
		this.house_building_area1 = house_building_area1;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_cre_carp_house_assessment_id", this.wms_cre_carp_house_assessment_id);
