...
public class WmsInveCreditSplitHead implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_inve_credit_split_head_id;
	
	private Integer wms_inve_credit_id;
	
	private Integer wms_inve_credit_split_spec_id;
	
	private Integer credit_split_total_amount;
	...
	*/	
	...
	public Integer getWms_inve_credit_id () {
		return wms_inve_credit_id;
	}
	
	public void setWms_inve_credit_id (Integer obj) {
		wms_inve_credit_id = obj;
	}
	...
	public Integer getCredit_split_total_amount () {
		return credit_split_total_amount;
	}
	
	public void setCredit_split_total_amount (Integer obj) {
		credit_split_total_amount = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		...
		paramMap.put("wms_inve_credit_id", this.wms_inve_credit_id);
		paramMap.put("wms_inve_credit_split_spec_id", this.wms_inve_credit_split_spec_id);
		paramMap.put("credit_split_total_amount", this.credit_split_total_amount);
