...
public class WmsCreCreditLineEnteFixedAssetVehicle implements BaseEntity
{
    private static final long serialVersionUID = 1L;

    private Integer wms_cre_credit_line_ente_fixed_asset_vehicle_id;

    private String license_plate;

    private String brand;

    private String train_load;
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cre_credit_line_ente_fixed_asset_vehicle_id" };

    private static String[] columnNameArr = { "wms_cre_credit_line_ente_fixed_asset_vehicle_id", "license_plate",
                                             "brand", "train_load", "use_year", "mileage", "property_owner", "status",
    ...
    public Integer getWms_cre_credit_line_ente_fixed_asset_vehicle_id()
    {
        return wms_cre_credit_line_ente_fixed_asset_vehicle_id;
    }

    public void setWms_cre_credit_line_ente_fixed_asset_vehicle_id(Integer obj)
    {
        wms_cre_credit_line_ente_fixed_asset_vehicle_id = obj;
    }
    ...
    public String getTrain_load()
    {
        return train_load;
    }

    public void setTrain_load(String obj)
    {
        train_load = obj;
    }
    ...
    {
        paramMap.put("wms_cre_credit_line_ente_fixed_asset_vehicle_id",
                     this.wms_cre_credit_line_ente_fixed_asset_vehicle_id);
        paramMap.put("license_plate", this.license_plate);
        paramMap.put("brand", this.brand);
        paramMap.put("train_load", this.train_load);
