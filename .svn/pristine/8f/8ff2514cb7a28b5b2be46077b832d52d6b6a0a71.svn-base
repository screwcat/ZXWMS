...
public class ActReProcdef implements BaseEntity
{
    ...
    private static String[] columnNameArr = { "id_", "rev_", "category_", "name_", "key_", "version_",
                                             "deployment_id_", "resource_name_", "dgrm_resource_name_", "description_",
    ...
    public void setResource_name_(String obj)
    {
        resource_name_ = obj;
    }
    ...
    public void setDgrm_resource_name_(String obj)
    {
        dgrm_resource_name_ = obj;
    }
    ...
    public void setHas_start_form_key_(Integer obj)
    {
        has_start_form_key_ = obj;
    }
    ...
    public void putInMap(Map<String, Object> paramMap)
    {
        ...
        paramMap.put("resource_name_", this.resource_name_);
        paramMap.put("dgrm_resource_name_", this.dgrm_resource_name_);
        paramMap.put("description_", this.description_);
        paramMap.put("has_start_form_key_", this.has_start_form_key_);
