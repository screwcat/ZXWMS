...
public class WmsCreCustomerChangeLineCompany implements BaseEntity
{
    private static final long serialVersionUID = 1L;

    private Integer wms_cre_customer_change_line_company_id;
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cre_customer_change_line_company_id" };

    private static String[] columnNameArr = { "wms_cre_customer_change_line_company_id",
                                             "wms_cre_credit_line_customer_change_head_id", "comp_full_name",
                                             "comp_tel", "compt_address_province", "comp_address_city",
                                             "comp_address_district", "comp_address_more", "found_date",
                                             "found_date_str", "comp_kind", "place_of_comp", "comp_industry",
                                             "create_user_id", "create_timestamp", "create_timestamp_str",
                                             "last_update_user_id", "last_update_timestamp",
                                             "last_update_timestamp_str", "enable_flag" };

    public Integer getWms_cre_customer_change_line_company_id()
    {
        return wms_cre_customer_change_line_company_id;
    }

    public void setWms_cre_customer_change_line_company_id(Integer obj)
    {
        wms_cre_customer_change_line_company_id = obj;
    }
    ...
    {
        paramMap.put("wms_cre_customer_change_line_company_id", this.wms_cre_customer_change_line_company_id);
