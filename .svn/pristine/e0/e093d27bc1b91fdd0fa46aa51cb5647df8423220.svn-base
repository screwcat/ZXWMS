...
public class WmsCreHousingCheck implements BaseEntity
{
    private static final long serialVersionUID = 1L;

    private Integer wms_cre_housing_check_id;
    ...
    private String transaction_price_caps;
    
    private BigDecimal unit_price;
    
    private String unit_price_caps;
    ...
    private String house_occupancy_rate;
    
    private String co_habitation;
    
    private String house_cleanliness;
    
    private String house_lighting;
    
    private String is_facetrial;
	...
	public void setIs_facetrial(String is_facetrial) {
		this.is_facetrial = is_facetrial;
	}
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cre_housing_check_id" };

    private static String[] columnNameArr = { "wms_cre_housing_check_id", "wms_cre_credit_head_id", "customer_name",
                                             "house_address", "house_building_area", "total_floor", "house_layer",
                                             "community_name", "housing_pattern", "building_age",
                                             "decoration_Standard", "house_usage", "online_fold",
                                             "house_transaction_price", "is_active", "rental_price",
                                             "house_people_review", "housing_towards", "common_occupants",
                                             "residential_environ", "residential_manage", "facilities", "remark",
                                             "transaction_price", "create_user_id", "create_user_name",
                                             "create_timestamp", "create_timestamp_str", "last_update_user_id",
                                             "last_update_timestamp", "last_update_timestamp_str", "enable_flag" };

    public Integer getWms_cre_housing_check_id()
    {
        return wms_cre_housing_check_id;
    }

    public void setWms_cre_housing_check_id(Integer obj)
    {
        wms_cre_housing_check_id = obj;
    }
    ...
    public String getTransaction_price_caps() {
		return transaction_price_caps;
	}

	public void setTransaction_price_caps(String transaction_price_caps) {
		this.transaction_price_caps = transaction_price_caps;
	}
	...
	public String getUnit_price_caps() {
		return unit_price_caps;
	}

	public void setUnit_price_caps(String unit_price_caps) {
		this.unit_price_caps = unit_price_caps;
	}
    ...
    {
        paramMap.put("wms_cre_housing_check_id", this.wms_cre_housing_check_id);
