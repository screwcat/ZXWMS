...
public class WmsInveDebtOlnclaims implements BaseEntity {
	private static final long serialVersionUID = 1L;
	
	private Integer wms_inve_debt_olnclaims_id;
	
	private Integer wms_inve_debt_head_id;
	
	private Integer wms_inve_transa_match_id;
	...
	*/	
	...
	public Integer getWms_inve_debt_olnclaims_id () {
		return wms_inve_debt_olnclaims_id;
	}
	
	public void setWms_inve_debt_olnclaims_id (Integer obj) {
		wms_inve_debt_olnclaims_id = obj;
	}
	
	public Integer getWms_inve_debt_head_id () {
		return wms_inve_debt_head_id;
	}
	
	public void setWms_inve_debt_head_id (Integer obj) {
		wms_inve_debt_head_id = obj;
	}
	
	public Integer getWms_inve_transa_match_id () {
		return wms_inve_transa_match_id;
	}
	
	public void setWms_inve_transa_match_id (Integer obj) {
		wms_inve_transa_match_id = obj;
	}
	...
	public String getOlnclaims () {
		return olnclaims;
	}
	
	public void setOlnclaims (String obj) {
		olnclaims = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		paramMap.put("wms_inve_debt_olnclaims_id", this.wms_inve_debt_olnclaims_id);
		paramMap.put("wms_inve_debt_head_id", this.wms_inve_debt_head_id);
		paramMap.put("wms_inve_transa_match_id", this.wms_inve_transa_match_id);
		...
		paramMap.put("olnclaims", this.olnclaims);
