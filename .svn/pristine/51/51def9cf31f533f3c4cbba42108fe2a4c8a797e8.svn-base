...
public class WmsCusCustomerLineWorkinfo implements BaseEntity
{
    ...
    private String work_unit_entry_date_str;
    ...
    private static String[] columnNameArr = { "wms_cus_customer_line_workinfo_id", "work_unit_full_name",
                                             ...
                                             "work_unit_telephone", "work_unit_entry_date", "work_unit_entry_date_str",
                                             "work_unit_department", "work_unit_duty", "work_unit_property",
    ...
    public String getWork_unit_entry_dateStr()
    {
        return work_unit_entry_date_str;
    }

    public void setWork_unit_entry_dateStr(String obj)
    {
        work_unit_entry_date_str = obj;
    }
    ...
    public void putInMap(Map<String, Object> paramMap)
    {
        ...
        paramMap.put("work_unit_entry_date_str", this.work_unit_entry_date_str);
