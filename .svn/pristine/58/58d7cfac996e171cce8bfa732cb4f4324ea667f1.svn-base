...
public class WmsCreHousingCustomerHouse implements BaseEntity
{
    ...
    private static String[] columnNameArr = { "id", "wms_cre_credit_head_id",
                                             "wms_cre_customer_change_line_houseinfo_id", "house_use",
    ...
    public void setHouse_use(String obj)
    {
        house_use = obj;
    }
    ...
    public void putInMap(Map<String, Object> paramMap)
    {
        ...
        paramMap.put("house_use", this.house_use);
