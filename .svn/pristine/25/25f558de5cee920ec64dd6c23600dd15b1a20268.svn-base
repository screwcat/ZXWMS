...
public class WmsCusCustomerLineWorkinfo implements Serializable
{
    private static final long serialVersionUID = 1L;

    private Integer wms_cus_customer_line_workinfo_id;
     ...
     * pk cols name array
     */
    private static String[] pkColArr = { "wms_cus_customer_line_workinfo_id" };

    private static String[] columnNameArr = { "wms_cus_customer_line_workinfo_id", "work_unit_full_name",
                                             ...
                                             "work_unit_duty", "work_unit_property", "wms_cus_customer_id",
                                             "create_user_id", "create_timestamp", "last_update_user_id",
                                             "last_update_timestamp", "enable_flag" };

    public Integer getWms_cus_customer_line_workinfo_id()
    {
        return wms_cus_customer_line_workinfo_id;
    }

    public void setWms_cus_customer_line_workinfo_id(Integer obj)
    {
        wms_cus_customer_line_workinfo_id = obj;
    }
    ...
    {
        paramMap.put("wms_cus_customer_line_workinfo_id", this.wms_cus_customer_line_workinfo_id);
    ...
    {
        if (paramMap.get("wms_cus_customer_line_workinfo_id") == null)
        {
            paramMap.remove("wms_cus_customer_line_workinfo_id");
        }
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_INSERT,
     ...
     */
    public static int deleteRecordsByPK(AbstractSimpleDao dao, Integer wms_cus_customer_line_workinfo_id)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("wms_cus_customer_line_workinfo_id", wms_cus_customer_line_workinfo_id);
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_DELETE, paramMap);
    }
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_UPDATE_ALL,
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_UPDATE,
     ...
     */
    public static WmsCusCustomerLineWorkinfo getRecordDomainByPK(AbstractSimpleDao dao,
                                                                 Integer wms_cus_customer_line_workinfo_id)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("wms_cus_customer_line_workinfo_id", wms_cus_customer_line_workinfo_id);
        WmsCusCustomerLineWorkinfo bean = dao.qryObj(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_LIST, paramMap,
                                                     WmsCusCustomerLineWorkinfo.class);
        return bean;
    }
     ...
     */
    public static WmsCusCustomerLineWorkinfoVO getRecordVOByPK(AbstractSimpleDao dao,
                                                               Integer wms_cus_customer_line_workinfo_id)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("wms_cus_customer_line_workinfo_id", wms_cus_customer_line_workinfo_id);
        List<Map<String, Object>> resList = dao.queryForListByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_LIST,
                                                                       paramMap);
        WmsCusCustomerLineWorkinfoVO bean = new WmsCusCustomerLineWorkinfoVO();
        if (resList.size() > 0)
        {
            Map<String, Object> row = resList.get(0);
            if (row.get("wms_cus_customer_line_workinfo_id") != null)
            {
                bean.setWms_cus_customer_line_workinfo_id((Integer) row.get("wms_cus_customer_line_workinfo_id"));
            }
    ...
    {
        return dao.updateByTemplate(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_DELETE,
                                    dealWithMapNullVal(this.getInfoMap()));
    }

    /**
     * get list by "and" method, need new WmsCusCustomerLineWorkinfo() include
     * query-params
     */
    public static List<WmsCusCustomerLineWorkinfo> getSingleTableListByAndMethod(AbstractSimpleDao dao,
                                                                                 WmsCusCustomerLineWorkinfo queryInfo,
                                                                                 Boolean isExcludePKFlag)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        if (queryInfo.getWms_cus_customer_line_workinfo_id() != null)
        {
            paramMap.put("wms_cus_customer_line_workinfo_id", queryInfo.getWms_cus_customer_line_workinfo_id());
        }
        ...
        return dao.qryObjList(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_LIST,
                              setSymbolPKPrior(paramMap, isExcludePKFlag, false), WmsCusCustomerLineWorkinfo.class);
    }

    /**
     * get list by "or" method, need new WmsCusCustomerLineWorkinfo() include
     * query-params
     */
    public static List<WmsCusCustomerLineWorkinfo> getSingleTableListByOrMethod(AbstractSimpleDao dao,
                                                                                WmsCusCustomerLineWorkinfo queryInfo,
                                                                                Boolean isExcludePKFlag)
    {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        ...
        return dao.qryObjList(SqlString.AUTO2_WMS_CUS_CUSTOMER_LINE_WORKINFO_LIST_BY_OR,
                              setSymbolPKPrior(paramMap, isExcludePKFlag, true), WmsCusCustomerLineWorkinfo.class);
    }
