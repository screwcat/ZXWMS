...
public class WmsInveTransaPruductRules implements BaseEntity {
	...
	*/	
	...
	public void setCommission_general_rules (Integer obj) {
		commission_general_rules = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		...
		paramMap.put("commission_general_rules", this.commission_general_rules);
